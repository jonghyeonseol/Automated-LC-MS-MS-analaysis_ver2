...
class GangliosideProcessor:
    ...
    def update_settings(self, outlier_threshold=None, r2_threshold=None, rt_tolerance=None):
        ...
        print(f"⚙️ 설정 업데이트: outlier={self.outlier_threshold}, r2={self.r2_threshold}, rt={self.rt_tolerance}")
    ...
    def process_data(self, df: pd.DataFrame, data_type: str = "Porcine") -> Dict[str, Any]:
        ...
        isomer_count = sum(1 for info in rule23_results['sugar_analysis'].values() if info['can_have_isomers'])
    ...
    def _compile_results(self, df: pd.DataFrame, rule1_results: Dict, rule23_results: Dict, 
        ...
        detailed_analysis = {
            'isomer_analysis': {
                ...
                'sugar_distribution': self._calculate_sugar_distribution(rule23_results['sugar_analysis'])
            },
